...
const usuariostalento_1 = __importDefault(require("../models/usuariostalento"));
const fs = __importStar(require("fs"));
const getUsuarios = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    usuariostalento_1.default().then((resultado) => {
...
const postUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    /* leo el archivo */
    try {
        const usuarios = yield usuariostalento_1.default();
